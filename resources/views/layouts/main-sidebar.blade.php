                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route("grades.index")}}">grade list</a></li>
                    ...
                    <li>
                        ...
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route("classrooms.index")}}"> classroom_list </a> </li>
                          
                        </ul>
                    </li>
                    <!-- menu item calendar-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calenda">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">sections </span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calenda" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route("sections.index")}}"> sections_list </a> </li>
